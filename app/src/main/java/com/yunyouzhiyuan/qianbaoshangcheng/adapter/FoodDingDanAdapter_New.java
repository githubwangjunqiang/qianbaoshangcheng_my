...
public class FoodDingDanAdapter_New extends MyAdapter<FoodDingdan_New.DataBean.GoodsinfoBean> {
    private List<FoodDingdan_New.DataBean.GoodsinfoBean> list;

    public FoodDingDanAdapter_New(Context context, List<FoodDingdan_New.DataBean.GoodsinfoBean> data) {
        super(context, data);
        list = new ArrayList<>();
        list.addAll(data);
    }
     ...
     * 更新数据
     */
    public void notifyDataChanged(List<FoodDingdan_New.DataBean.GoodsinfoBean> data) {
        this.list.clear();
