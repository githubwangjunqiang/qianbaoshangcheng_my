 ...
 */
public class SpannerAdapterShop extends BaseAdapter {
    private Context context;
    private List<ShopLeixing.DataBean> list;

    public SpannerAdapterShop(Context context, List<ShopLeixing.DataBean> list) {
