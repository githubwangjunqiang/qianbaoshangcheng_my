 ...
 */
public class SpannerAdapterTuanGou extends BaseAdapter {
    private Context context;
    private List<HuoDongTuangou.DataBean> list;

    public SpannerAdapterTuanGou(Context context, List<HuoDongTuangou.DataBean> list) {
...
//        textView.setBackgroundColor(ContextCompat.getColor(context, R.color.white));
        ...
        textView.setText(list.get(position).getGoods_name());
        return textView;
    }
}
